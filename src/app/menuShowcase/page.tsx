...
export default function Home() {
  ...
  return (
    ...
    "
    >
      <div className="min-h-[calc(100vh-3rem)] flex flex-col w-full">
        {/* navbar */}
          ...
          >
            <div className="max-w-7xl mx-auto mb-6">
              <div
                ...
                className="
          relative w-full bg-gradient-to-r from-orange-400 to-orange-500
          rounded-2xl py-5 px-6 cursor-pointer transition-all 
          duration-300 hover:shadow-xl active:scale-[0.98]
          flex items-center justify-start gap-3     /* ← Aquí el cambio */
        "
              >
